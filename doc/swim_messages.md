...
for authentication. See [`encrypt/3`](#encrypt-3) for more information. The
...
event. See <a href="swim_membership.md"><code>swim_membership</code></a> for more information on Incarncations.</dd>
...
Encodes a Member as the IPv4 address and port number combination.
